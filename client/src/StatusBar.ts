/* Manages the status bar at the bottom of vscode.
 */
...
class SolidityStatusBarManager implements vscode.Disposable {
  ...
  constructor() {
    ...
    this.statusBar.text = 'Loading Solidity';
    this.statusBar.show();
    ...
    this.interruptButtonStatusBar.tooltip = 'Interrupt Solidity computation';
    this.interruptButtonStatusBar.color = 'rgba(255,100,100,1)';
    this.interruptButtonStatusBar.command = 'extension.solidity.interrupt';
  ...
  public showState(state: State) {
    ...
    switch(state.status) {
      case 'stopped': {
        // this.statusBar.text = 'soliditytop is not running.';
        this.statusBar.text = '';
...
export class StatusBar implements vscode.Disposable {
  private static manager : SolidityStatusBarManager|null = null;
  ...
  constructor() {
    if(StatusBar.manager === null) {
      StatusBar.manager = new SolidityStatusBarManager();
    }
  ...
  public setSoliditytopStatus(running: boolean) {
